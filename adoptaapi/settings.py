"""
Django settings for adoptaapi project.
...
SECRET_KEY = 'django-insecure-me$g+iy0!h46aji$+3_)a^@j2=#komnk=n%l6!f8uw(bx=&(e5'
...
WSGI_APPLICATION = 'adoptaapi.wsgi.application'
